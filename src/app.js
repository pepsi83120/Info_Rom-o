...
function renderNav() {
  ...
  document.getElementById("nav").innerHTML = `
    ...
    ${navItem("tasks", "ti-list-check", "Operations", openTasks)}
    ${navItem("events", "ti-calendar-star", "Evenements", activeEventsCount())}
...
function renderHeader() {
  const labels = {
    ...
    tasks: ["Operations", "Menage, maintenance et conciergerie terrain"],
    events: ["Evenements", "Experiences et annonces visibles cote client"],
